...
import io.connectedhealth_idaas.eventbuilder.pojos.clinical.fhir.PatientResource.Address;
import io.connectedhealth_idaas.eventbuilder.pojos.clinical.fhir.PatientResource.Identifier;
import io.connectedhealth_idaas.eventbuilder.pojos.clinical.fhir.PatientResource.Name;
import io.connectedhealth_idaas.eventbuilder.pojos.clinical.fhir.PatientResource.Photo;
import io.connectedhealth_idaas.eventbuilder.pojos.clinical.fhir.PatientResource.Telecom;
import io.connectedhealth_idaas.eventbuilder.pojos.clinical.fhir.PatientResource.Text;
import io.connectedhealth_idaas.eventbuilder.pojos.clinical.fhir.PatientResource.*;
